...
const projects = [
  ...
  {
    name: 'survey.trendx.co',
    link: 'https://survey.trendx.co/',
    image: '/Capture02.PNG',
    description: 'Interactive survey platform with dynamic matrix questions, built using Next.js, Redux Toolkit, and TailwindCSS.',
    tech: ['react', 'tailwind', 'redux'],
  },
  {
    name: 'Omar Portfolio',
